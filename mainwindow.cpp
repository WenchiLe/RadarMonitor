    ...
    ui(new Ui::MainWindow)
{
    ...
    //hide the buttons
    ui->pushButton_road_left->setVisible(false);
    ui->pushButton_road_right->setVisible(false);
    ui->pushButton_road_shrink->setVisible(false);
    ui->pushButton_road_enlarge->setVisible(false);
...
//    }
    ...
    int y = (int)(840 - lastFrame60Bs.frame[j][1] * 1.5);
