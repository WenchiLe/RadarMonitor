...
int RangeSlider::firstLocateX()
{
    float percentage = (mLowerValue - mMinimum) * 1.0 / mInterval;
    return percentage * validWidth() + scLeftRightMargin;
}

int RangeSlider::secondLocateX()
{
    float percentage = (mUpperValue - mMinimum) * 1.0 / mInterval;
    return percentage * validWidth() + scLeftRightMargin + scHandleSideLength;
}
